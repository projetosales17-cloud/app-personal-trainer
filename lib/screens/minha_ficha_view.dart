  ...
  Future<void> _trocarExercicio(
    ...
    if (alternativas.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Sem outra opção para esse grupo agora.')),
      );
      return;
    }
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('Não fazer este exercício'),
              subtitle: const Text('Sai do seu treino até o próximo check-in'),
                ...
                return FutureBuilder<Map<String, String>>(
                  ...
                  children: [
                      ...
                      Card(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                'Você terminou o bloco ${programa.blocoAtual}',
                                style: Theme.of(context).textTheme.titleSmall,
                              ),
                              const SizedBox(height: 4),
                              const Text(
                                'Faça seu check-in de progresso pra gerar a próxima ficha.',
                              ),
                    ...
                    if (gruposEvitados.isNotEmpty) ...[
                      const SizedBox(height: 4),
                      Text(
                        'Treino sem: ${gruposEvitados.map((g) => g.label).join(', ')} '
                        '— ajuste em Perfil › Editar meus dados.',
                    ...
                    if (semMusculacao &&
                      ...
                      Card(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(12),
                          child: Text(
                            'Você marcou grupos demais para evitar: seu treino está só '
                            'com cardio. Solte algum grupo em Perfil › Editar meus dados '
                            'para voltar a musculação.',
                            style: TextStyle(
        ...
        child: Column(
          ...
          children: [
            ...
            if (semanasParaCheckin != null && semanasParaCheckin! > 0) ...[
              const SizedBox(height: 6),
              Text(
                'Próximo check-in de progresso em $semanasParaCheckin semana(s).',
                style: Theme.of(context).textTheme.bodySmall,
              ),
            ],
          ],
          ...
          children: [
            ...
            for (var i = 0; i < exerciciosExibidos.length; i++)
              if (idsRemovidos.contains(exerciciosOriginais[i].id))
                ListTile(
                  ...
                  subtitle: const Text('Fora do treino'),
                  trailing: TextButton(
            ...
            if (exerciciosExibidos.isNotEmpty &&
              ...
              Padding(
                ...
                child: Text(
                  'Você tirou todos os exercícios deste dia.',
                  style: Theme.of(context).textTheme.bodySmall,
                ),
              ),
...
class _ExercicioTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      subtitle: Text(
        trocado
            ? '${exibido.grupoMuscularPrincipal.label} · no lugar de ${original.nome}'
        ...
        children: [
          if (trocado)
            IconButton(
              ...
              tooltip: 'Voltar ao exercício original',
