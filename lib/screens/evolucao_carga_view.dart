        ...
        if (evolucoes.isEmpty) {
          return const Center(
            child: Padding(
              ...
              child: Text(
                'Registra la carga de tus ejercicios (en la pestaña '
                'Entrenamiento, abriendo cada ejercicio) durante al menos dos '
                'sesiones para ver la evolución aquí.',
            ...
            if (progrediram > 0) ...[
              Card(
                ...
                child: Padding(
                  ...
                  child: Text(
                    'Aumentaste la carga en $progrediram ejercicio(s). '
                    'Eso es fuerza que se nota en el día a día, no solo en la balanza.',
          ...
          children: [
            ...
            Text(
              evolucao.progrediu
                  ...
                  : 'Carga estable en ${_kg(evolucao.pesoAtual)} a lo largo de '
